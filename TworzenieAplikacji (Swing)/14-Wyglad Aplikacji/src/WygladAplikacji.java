 ...
 * @author u180
 */
public class WygladAplikacji extends javax.swing.JFrame {

    /**
     * Creates new form WygladAplikacji
     */
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(WygladAplikacji.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new WygladAplikacji().setVisible(true);
            }
        });
    }
